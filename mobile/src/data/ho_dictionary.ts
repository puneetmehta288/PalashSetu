...
export const HINDI_TO_HO_VOCAB: Record<string, { ho: string; phonetic: string; warang?: string }> = {
  ...
  'एक (1)': { ho: 'मियद (1)', phonetic: 'Miyad' },
  'दो (2)': { ho: 'बारिया (2)', phonetic: 'Baria' },
  'तीन (3)': { ho: 'अपिया (3)', phonetic: 'Apia' },
  'चार (4)': { ho: 'उपुनिया (4)', phonetic: 'Upunia' },
  'पाँच (5)': { ho: 'मोया (5)', phonetic: 'Moya' },
  'छह (6)': { ho: 'तुरिया (6)', phonetic: 'Turia' },
  'सात (7)': { ho: 'एया (7)', phonetic: 'Eya' },
  'आठ (8)': { ho: 'इरिलिया (8)', phonetic: 'Irilya' },
  'नौ (9)': { ho: 'आरेया (9)', phonetic: 'Areya' },
  'दस (10)': { ho: 'गेलेया (10)', phonetic: 'Geleya' },
  'गोला (वृत्त)': { ho: 'गुल (वृत्त)', phonetic: 'Gul' },
  'चौकोर (वर्ग)': { ho: 'चारकोना (वर्ग)', phonetic: 'Charkona' },
  'तिकोना (त्रिभुज)': { ho: 'पेकोना (त्रिभुज)', phonetic: 'Pekona' },
  'आयत (Rectangle)': { ho: 'आयत (Rectangle)', phonetic: 'Ayat' },
  'तारा': { ho: 'इपिल (तारा)', phonetic: 'Ipil' },
  'बड़ा / छोटा': { ho: 'मारांग / हुड़िंग', phonetic: 'Marang / Huding' },
  'लंबा / छोटा': { ho: 'जिलिंग / खाटो', phonetic: 'Jiling / Khato' },
  'ज़्यादा / कम': { ho: 'पूरा / कम', phonetic: 'Pura / Kam' },
  'भारी / हल्का': { ho: 'हाम्बल / रावाल', phonetic: 'Hambal / Rawal' },
  'गर्म / ठंडा': { ho: 'लोलो / रियांग', phonetic: 'Lolo / Riyang' },
  'जोहार (नमस्ते)': { ho: 'जोहार', phonetic: 'Johar' },
  'हाँ / नहीं': { ho: 'हे / का (बांग)', phonetic: 'He / Ka' },
  'बैठो / खड़े हो': { ho: 'दुबमे / तिंगुन्मे', phonetic: 'Dubme / Tinguinme' },
  'दिन / रात': { ho: 'सिंगी / निदा', phonetic: 'Singi / Nida' },
  'गाँव / शहर': { ho: 'हातू / साहार', phonetic: 'Hatu / Sahar' },
  'आना / जाना': { ho: 'हिजुः / सेनोः', phonetic: 'Hiju / Seno' },
  'तेज़ / धीरे': { ho: 'लॉगन / बायो-बायो', phonetic: 'Logon / Bayo-bayo' },
  'सोहराय (त्योहार)': { ho: 'मागे / सोहराय (त्योहार)', phonetic: 'Mage / Sohray' },
  'उंगली': { ho: 'गांडा', phonetic: 'Ganda' },
};
