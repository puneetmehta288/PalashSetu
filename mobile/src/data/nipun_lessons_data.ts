...
export const LESSON_DB: Record<string, LessonData> = {
...
export function getLessonKey(grade: string, subject: string, topicIndex: number): string {
...
export const STEP_COLORS: Record<number, { bg: string; border: string; header: string; label: string }> = {
